								...
								<tbody>
									...
									<c:forEach var="hoadon" items="${hoadon }">
										<tr>
											...
											<td class="noibat">${hoadon.getKhachhang().getSODIENTHOAI()}</td>
											...
											<td>
											<a href="/VTNN/admin/${hoadon.getMAHOADON() }">
												<button type="button" class="btn btn-primary"data-toggle="modal" data-target="#exampleModalCenter">Chi Tiết</button>
											</a>
												</td>
										</tr>
									</c:forEach>
