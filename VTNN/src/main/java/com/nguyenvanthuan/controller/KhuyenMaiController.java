...
public class KhuyenMaiController {
	...
	public String update(ModelMap modelMap, @RequestParam int id, @RequestParam String tenkm,
			@RequestParam Date ngaybatdau, @RequestParam Date ngayketthuc, @RequestParam int phantram,
	...
	public String themthuyenmai() {
		return "themkhuyenmai";
	}
	@PostMapping("themkhuyenmai")
	public String save(ModelMap modelMap, @RequestParam String tenkm,
			@RequestParam Date ngaybatdau, @RequestParam Date ngayketthuc, @RequestParam int phantram,
			@RequestParam String mota) {
		if (khuyenmaiservice.savekhuyenmai(tenkm, ngaybatdau, ngayketthuc, phantram, mota)) {
			return "redirect:/khuyenmai/";
		} else {
			String error = "Lỗi nhập dữ liệu. Xin kiểm tra lại !";
			modelMap.addAttribute("loi", error);
